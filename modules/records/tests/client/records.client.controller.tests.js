  ...
  describe('Records Controller Tests', function () {
    ...
    describe('vm.save() as create', function () {
      ...
      beforeEach(function () {
        ...
        sampleRecordPostData = new RecordsService({
          name: 'Record Name'
        });

        $scope.vm.record = sampleRecordPostData;
      });

      it('should send a POST request with the form input values and then locate to new object URL', inject(function (RecordsService) {
        // Set POST response
        ...
        expect($state.go).toHaveBeenCalledWith('records.view', {
    ...
    describe('vm.save() as update', function () {
      beforeEach(function () {
        ...
        $scope.vm.record = mockRecord;
      });

      it('should update a valid Record', inject(function (RecordsService) {
        // Set PUT response
      ...
      it('should set $scope.vm.error if error', inject(function (RecordsService) {
    ...
    describe('vm.remove()', function () {
      ...
      it('should delete the Record and redirect to Records', function () {
        ...
        expect($state.go).toHaveBeenCalledWith('records.list');
      });

      it('should should not delete the Record and not redirect', function () {
