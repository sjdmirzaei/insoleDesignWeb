...
exports.invokeRolesPolicies = function () {
    acl.allow([{
        ...
        allows: [{
            ...
            {
                resources: '/api/records/download/:recordId',
                permissions: ['get', 'post']
            },
            {
                resources: '/api/records/download/last/:recordId',
                permissions: ['get', 'post']
            }]
    }, {
        roles: ['user'],
        allows: [{
            ...
            {
                resources: '/api/records/download',
                permissions: ['get', 'post']
            }]
    },
        {
